## Projeto Prático de Fundamentos de Python: Gerenciador de Eventos e Agendamentos Simples

Este projeto "mão-na-massa" tem como objetivo consolidar conhecimentos essenciais de Python, focando na manipulação de **datas, horários e gerenciamento de arquivos**. Ao final, teremos um sistema funcional de agendamento que resolve um problema prático do dia a dia.
